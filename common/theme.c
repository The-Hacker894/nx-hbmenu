...
void themeStartup(ThemePreset preset) {
    ...
    theme_t themeDark = (theme_t) { 
        .textColor = MakeColor(243, 241, 239, 1),
        .frontWaveColor = MakeColor(248, 148, 6, 1),
        .middleWaveColor = MakeColor(253, 227, 167, 1),
        .backWaveColor = MakeColor(0, 0, 0,1),
        .backgroundColor = MakeColor(0, 0, 0,1),
        .highlightColor = MakeColor(46, 49, 49, 1),
        .separatorColor = MakeColor(46, 49, 49, 0),
        .borderColor = MakeColor(0, 0, 0, 1),
        .borderTextColor = MakeColor(46, 49, 49, 1),
        .progressBarColor = MakeColor(0, 0, 0, 1),
        .enableWaveBlending = 0,
        .buttonAText = "\uE0A0",
        .buttonBText = "\uE0A1",
        .buttonYText = "\uE0A3",
